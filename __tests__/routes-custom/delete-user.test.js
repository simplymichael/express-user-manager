...
describe(`Delete User: DELETE ${apiUrl}${customRoutes.deleteUser}/:userId`, async () => {
  let user = null;
  let deleteRoute = `${apiUrl}${customRoutes.deleteUser}/`;
  ...
  afterEach((done) => {
    user = null;
    deleteRoute = `${apiUrl}${customRoutes.deleteUser}/`;
    done();
  });
